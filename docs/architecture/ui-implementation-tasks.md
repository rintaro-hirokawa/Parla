...
- `PracticeService`: `request_model_audio()`, `should_skip()`, `evaluate_overlapping()`, `evaluate_live_delivery()`
...
- 練習: `ModelAudioRequested`, `ModelAudioReady`, `ModelAudioFailed`, `OverlappingCompleted`, `LiveDeliveryCompleted`, `PassageAchievementRecorded`
...
- [x] **5-3: 録音画面 (SCREEN-E3)**
  - ファイル: `src/parla/ui/screens/session/recording_view.py`, `src/parla/ui/screens/session/recording_view_model.py`
  - テスト: `tests/ui/screens/session/test_recording_view_model.py`, `tests/ui/screens/session/test_recording_view.py`
...
- [x] **5-4: フィードバック画面 (SCREEN-E4)** ← 最も複雑
  - ファイル: `src/parla/ui/screens/session/feedback_view.py`, `src/parla/ui/screens/session/feedback_view_model.py`
  - テスト: `tests/ui/screens/session/test_feedback_view_model.py`, `tests/ui/screens/session/test_feedback_view.py`
...
- [x] **5-6: 通し練習ワークスペース (SCREEN-E6)** ← 2番目に複雑
  - ファイル: `src/parla/ui/screens/session/run_through_view.py`, `src/parla/ui/screens/session/run_through_view_model.py`
  - テスト: `tests/ui/screens/session/test_run_through_view_model.py`, `tests/ui/screens/session/test_run_through_view.py`
  ...
  - サービス連携:
    ...
    - オーバーラッピング: モデル音声再生+同時録音 → `PracticeService.evaluate_overlapping()`
    - 本番発話: 録音 → `PracticeService.evaluate_live_delivery()`
  - イベント: `ModelAudioReady/Failed`, `OverlappingCompleted`, `LiveDeliveryCompleted`
  - 練習順序・回数はユーザー自由（推奨アクションは表示してよい）
  - テスト観点: モード切替、各モードのサービス連携、結果表示

- [x] **5-7: パッセージ完了サマリー (SCREEN-E9)**
